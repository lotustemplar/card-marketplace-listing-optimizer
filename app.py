...
def main() -> None:
    ...
    st.info("Use either a native TCGPlayer export or two ManaBox pricing exports with the same inventory slice: one priced to TCGPlayer market and one priced to Manapool market.")
